...
export function Navbar() {
  ...
  const activeClass = ({ isActive }) =>
    `px-4 py-2 text-sm font-medium transition-all duration-200 border-b-2 flex items-center gap-1.5 ${isActive
      ...
      <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <NavLink to="/" className="flex items-center gap-3 group">
          <img
            ...
            className="w-20 h-20 rounded-full object-cover border-2 border-white bg-amber-50/50"
          />
          <div>
